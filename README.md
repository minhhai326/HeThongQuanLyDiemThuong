...
|-----|--------------------|--------------|-----------------------------------------|---------------------------------------------------------------------------------------------------------|
| 2   | Bùi Thị Minh Hải   | K24DTCN189   | Frontend Lead + UI/UX                   | 1. Thiết kế lại toàn bộ giao diện (trang chủ, lịch sử, admin dashboard).                                |
|     |                    |              | + Java Controller                       | 2. Triển khai responsive cho mobile/tablet/PC.                                                          |
